namespace FakeItEasy
{
    ...
    public static class ExceptionThrowerConfigurationExtensions
    {
        ...
        /// <returns>Configuration object.</returns>
        /// <exception cref="FakeConfigurationException">The signatures of the faked method and the <paramref name="exceptionFactory"/> do not match.</exception>
        public static IAfterCallSpecifiedConfiguration Throws<T1, T2, T3, T4, T5>(this IExceptionThrowerConfiguration configuration, Func<T1, T2, T3, T4, T5, Exception> exceptionFactory)
        {
            Guard.AgainstNull(configuration, "configuration");
        ...
        /// <typeparam name="T4">Type of the fourth argument of the faked method call.</typeparam>
        /// <typeparam name="T5">Type of the fifth argument of the faked method call.</typeparam>
        /// <typeparam name="T6">Type of the fifth argument of the faked method call.</typeparam>
        /// <returns>Configuration object.</returns>
        /// <exception cref="FakeConfigurationException">The signatures of the faked method and the <paramref name="exceptionFactory"/> do not match.</exception>
        public static IAfterCallSpecifiedConfiguration Throws<T1, T2, T3, T4, T5, T6>(this IExceptionThrowerConfiguration configuration, Func<T1, T2, T3, T4, T5, T6, Exception> exceptionFactory)
        {
            Guard.AgainstNull(configuration, "configuration");
